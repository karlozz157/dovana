...
<?php if($sliders): ?>
<div id="slider1_container" class="slider-index" style="position: relative; top: 0px; left: 0px; height: 712px; width: 1020px;">
    <div u="slides" style="border: 3px solid #73787C; cursor: move; position: absolute; overflow: hidden; left: 0px; top: 0px; 	height: 712px; width: 1020px;">
...
<?php if($promociones): ?>
<div id="slider2_container" class="slider-index" style="position: relative; top: 0px; left: 0px; height: 712px; width: 1020px;">
    <div u="slides" style="border: 3px solid #73787C; cursor: move; position: absolute; overflow: hidden; left: 0px; top: 0px; 	height: 712px; width: 1020px;">
